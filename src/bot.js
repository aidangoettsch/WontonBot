  ...
  constructor () {
    ...
    this.client.on('ready', () => {
      ...
      bot.editStatus('online', {
        name: 'v' + this.meta.version + ' // by ' + this.meta.owner
      })
    })
...
bot.registerCommand(new Command('ping', 'Test the bot by sending a test reply.')).on('commandRun', (msg) => {
  bot.logger.log('debug', 'Pong!', [msg.channel], true)
})
